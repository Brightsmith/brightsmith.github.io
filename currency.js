! function() {
  ...
  function e() {
    ...
    function o(t, e, a, i, r, o, d, s) {
      ...
      if (e) h = '' + l + '' + n(r, s, i);
      return detailedHTML = '', detailedHTML
    }
    ...
    function d(a, i, r, n, d, s, c, l, p, u, h, f, m, v, g, x, y) {
      ...
      return k += o(v, g, x, y, d, f, valMarketCap, valVolume), k += '    <div style="text-align:center;clear:both;font-size:10px;font-style:italic;padding:5px 0;">    </div></div>'
    }
